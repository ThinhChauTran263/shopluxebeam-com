        ...
        .then(data => {
          ...
          if (data.items.length > 0) {
            ...
            data.items.forEach((item, index) => {
              const line = index + 1;
              itemsHTML += '<div class="cart-drawer-item" data-line="' + line + '"><div class="cart-item-image">' + (item.image ? '<img src="' + item.image + '" alt="' + item.title + '" width="100" height="100">' : '') + '</div><div class="cart-item-details"><h3 class="cart-item-title">' + item.product_title + '</h3><div class="cart-item-price-qty"><span class="cart-item-quantity">' + item.quantity + '×</span><span class="cart-item-price">' + formatMoney(item.final_price) + '</span></div><div class="cart-item-controls"><div class="quantity-selector"><button class="qty-btn qty-minus" data-line="' + line + '">−</button><input type="number" class="qty-input" value="' + item.quantity + '" data-line="' + line + '"><button class="qty-btn qty-plus" data-line="' + line + '">+</button></div><button class="cart-item-remove" data-line="' + line + '"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div></div></div>';
            });
      ...
      .then(data => {
        ...
        if (data.items.length > 0) {
          ...
          data.items.forEach((item, index) => {
            ...
            itemsHTML += '<div class="cart-drawer-item" data-line="' + itemLine + '"><div class="cart-item-image">' + (item.image ? '<img src="' + item.image + '" alt="' + item.title + '" width="100" height="100">' : '') + '</div><div class="cart-item-details"><h3 class="cart-item-title">' + item.product_title + '</h3><div class="cart-item-price-qty"><span class="cart-item-quantity">' + item.quantity + '×</span><span class="cart-item-price">' + formatMoney(item.final_price) + '</span></div><div class="cart-item-controls"><div class="quantity-selector"><button class="qty-btn qty-minus" data-line="' + itemLine + '">−</button><input type="number" class="qty-input" value="' + item.quantity + '" data-line="' + itemLine + '"><button class="qty-btn qty-plus" data-line="' + itemLine + '">+</button></div><button class="cart-item-remove" data-line="' + itemLine + '"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg></button></div></div></div>';
          });
          if (itemsContainer) itemsContainer.innerHTML = itemsHTML;
          if (footer) footer.style.display = 'block';
        } else {
